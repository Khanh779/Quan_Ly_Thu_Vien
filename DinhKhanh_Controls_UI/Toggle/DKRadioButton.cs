...
namespace DinhKhanh_Controls_UI.Toggle
{
    public class DKRadioButton : Control
    {
        #region Variables


        Color enabledCheckedColor = ColorHelper.NormalColor;
        ...
        private void UpdateState()
        {
            ...
            {
                if (!ReferenceEquals(c, this) && c is DKRadioButton)
                {
                    ((DKRadioButton)c).Checked = false;
                }
            }
        }
        ...
        Color fbc = ColorHelper.NormalColor;
        ...
        public Color RippleColor { get; set; } = ColorHelper.HoverColor;
