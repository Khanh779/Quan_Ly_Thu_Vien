...
namespace HeCopUI_Framework.Controls.Button
{
    ...
    public partial class DKCheckBox : Control
    {
        #region Variables
        ...
        Color checkboxc1 = ColorHelper.NormalColor;
        ...
        Color checkboxc2 = ColorHelper.HoverColor;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            using (var checkmarkPath = GraphicsHelper.GetRoundPath(new RectangleF(6f, 6, 15, 15), 0))
